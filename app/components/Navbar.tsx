...
export const Navbar = () => {
  ...
  return (
    <React.Fragment>
      <header id="header-nav" className="sticky top-0 left-0 right-0 z-30">
        <nav
          id="app-nav"
          className={`flex items-center justify-between p-6 bg-background-light dark:bg-stone-900 rounded-b-3xl dark:shadow-stone-800 ${
            pathname === "/" ? "pt-24 md:pt-16" : ""
          }`}
          aria-label="Global"
        >
      ...
      {isOpen && (
        <div className="lg:hidden" role="dialog" aria-modal="true">
          ...
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-background-light dark:bg-stone-900 px-6 py-6 sm:max-w-sm shadow-md dark:shadow-stone-800">
              ...
              <div className="-my-6 divide-y divide-accent-500 dark:divide-accent-400">
                <div className="space-y-2 py-6">
                  <Link
                    onClick={() => setIsOpen(false)}
                    href="/about"
                    className="-mx-3 block rounded-lg px-3 py-2 text-2xl font-semibold leading-7 text-text-light hover:bg-primary-100 dark:text-text-dark hover:dark:bg-primary-500"
                  >
                    About Us
                  </Link>
                  <Link
                ...
                <div className="py-6">
                  <Link
                    onClick={() => setIsOpen(false)}
                    href="/new"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-2xl font-semibold leading-7 text-text-light hover:bg-primary-100 dark:text-text-dark hover:dark:bg-primary-500"
                  >
                    I&apos;m New
                  </Link>
                </div>
